...
export default function Home({ providers }: HomeProps): JSX.Element {
  ...
  if (status === 'authenticated') {
    return <TaskList todos={todos} onToggle={handleToggleTodo} onDelete={handleDeleteTodo} onAdd={handleAddTodo} />
  }
  ...
  return (
    <>
      <h1 className='text-tl-light text-4xl md:text-7xl mb-16 font-extrabold md:w-3/4'>
        Stay on top of your daily task and improve productivity
      </h1>
